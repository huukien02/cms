  ...
  const handleCreate = async () => {
    ...
    if (accounts.length > 0) {
      accounts.forEach((org, index) => {
        // formData.append(`user_orgs[${index}][flag]`, 'CREATED')
    ...
    try {
      await axiosInstanceSystemAdmin.post(
        `/api/system_admin/1.0/organizations/create`,
        formData,
      )
      ...
      <CardComponent>
                ...
                <ContainerImageWrapper>
                  ...
                  <UploadContainer>
                    ...
                    <ConditionList>
                      ...
                      <ConditionItem>・ファイルサイズ：5MB 以下</ConditionItem>
                      <ConditionItem>
                        ・画像サイズ：380 × 290 ピクセル
                      </ConditionItem>
                    </ConditionList>
                  ...
                  {!isInternal && (
                    <div className="mt-[15px] p-[15px]">
                      <BoxInput>
                        <label
                          htmlFor=""
                          className="label w-[500px] font-[600]"
                        >
                          バケット名
                        </label>
                        <Input
        ...
        <ButtonContainer>
          ...
          <CommonPrimaryButton
            ...
            onClick={openModal}
            style={{
              backgroundColor: isEnableButton ? '#DADADD' : '#E6791A',
              border: 'none',
              color: '#FFFFFF',
            }}
