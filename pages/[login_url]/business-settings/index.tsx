...
import { axiosInstance, axiosInstanceSystemAdmin } from '@/libs'
import { USER_ROLE } from '@/common/auth'
import Button from '@/components/Button'
import { OrganizationType } from '@/pages/system-admin/organization'
...
const DetailOrganization = () => {
  ...
  const handleEdit = () => {
    router.push(
      `/${login_url}/business-settings/edit?organization_id=${organization?.id}`,
    )
  }
